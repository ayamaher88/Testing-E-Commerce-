...
public class CartPageTestCase2 extends BaseTest {
    ...
    public void testlogin(String username, String password) {
        ...
        WebElement pageTitle = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h2[text()='Samsung galaxy s6']")));
