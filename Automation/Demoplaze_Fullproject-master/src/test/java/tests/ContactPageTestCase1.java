...
public class ContactPageTestCase1 extends BaseTest {
    @DataProvider(name = "vaildcontactinformation")
    public Object[][] logindata() throws IOException {
        String sheetName = "Sheet13";
        return ExcelReader.getlogindata(sheetName);
    }
    @Test(dataProvider = "vaildcontactinformation")
