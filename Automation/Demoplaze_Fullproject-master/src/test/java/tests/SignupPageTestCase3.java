...
public class SignupPageTestCase3 extends BaseTest {
    @DataProvider(name = "validsignuppasswordandemptyusername")
    public Object[][] logindata() throws IOException {
        String sheetName = "Sheet6";
        return ExcelReader.getlogindata(sheetName);
    }
    @Test(dataProvider = "validsignuppasswordandemptyusername")
