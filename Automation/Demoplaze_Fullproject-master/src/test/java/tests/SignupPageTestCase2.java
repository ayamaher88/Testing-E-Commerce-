...
public class SignupPageTestCase2 extends BaseTest {
    @DataProvider(name = "validsignupusernameandemptypassword")
    public Object[][] logindata() throws IOException {
        String sheetName = "Sheet5";
        return ExcelReader.getlogindata(sheetName);
    }
    @Test(dataProvider = "validsignupusernameandemptypassword")
